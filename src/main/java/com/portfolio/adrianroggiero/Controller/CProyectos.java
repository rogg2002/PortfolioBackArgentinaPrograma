...
public class CProyectos {
    ...
    public ResponseEntity<?> delete(@PathVariable("id") int id) {
        ...
        return new ResponseEntity(new Mensaje("se elimino proyecto"), HttpStatus.OK);
    }
        //creo proyectos
    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtopro){      
        ...
        if(sProyectos.existsByNombrePro(dtopro.getNombrePro()))
            return new ResponseEntity(new Mensaje("proyecto no existe"), HttpStatus.BAD_REQUEST);
        
        Proyectos proyectos = new Proyectos(dtopro.getNombrePro(), dtopro.getDescripcionPro(), dtopro.getLinkPro());
        sProyectos.save(proyectos);
        
        return new ResponseEntity(new Mensaje("se agrego proyecto"), HttpStatus.OK);
    }
        // update a proyectos
